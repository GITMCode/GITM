          ...
          if ((j0 > 0) .and. (k0 > 0) .and. (l0 > 0)) then
            ...
            do iIon = 1, 5
              if (data_inp(iIon + 3) <= 0) then
                ...
                print *, '--> ', iproc, SAMIVars_g(1:2, k0, j0, i0), &
                  SAMIVars_g(3, k0, j0, i0) - re, SAMIVars_g(iIon + 3, k0, j0, i0)
                print *, '--> '
                print *, '-->' &
                  , SAMIVars_g(1:2, k1, j0, i0), &
                  SAMIVars_g(3, k1, j0, i0) - re, SAMIVars_g(iIon + 3, k1, j0, i0)
                print *, '--> '
                print *, '--> ' &
                  , SAMIVars_g(1:2, l0, j1, i0), &
                  SAMIVars_g(3, l0, j1, i0) - re, SAMIVars_g(iIon + 3, l0, j1, i0)
                print *, '--> '
                print *, '--> ', &
                  SAMIVars_g(1:2, l1, j1, i0), &
                  SAMIVars_g(3, l1, j1, i0) - re, SAMIVars_g(iIon + 3, l1, j1, i0)
                print *, '--> '
                print *, '--> ', &
                  SAMIVars_g(1:2, k0, j0, i1), &
                  SAMIVars_g(3, k0, j0, i1) - re, SAMIVars_g(iIon + 3, k0, j0, i1)
                print *, '--> '
                print *, '--> ', &
                  SAMIVars_g(1:2, k1, j0, i1), &
                  SAMIVars_g(3, k1, j0, i1) - re, SAMIVars_g(iIon + 3, k1, j0, i1)
                print *, '--> '
                print *, '--> ', &
                  SAMIVars_g(1:2, l0, j1, i1), &
                  SAMIVars_g(3, l0, j1, i1) - re, SAMIVars_g(iIon + 3, l0, j1, i1)
                print *, '--> '
                print *, '--> ', &
                  SAMIVars_g(1:2, l1, j1, i1), &
                  SAMIVars_g(3, l1, j1, i1) - re, SAMIVars_g(iIon + 3, l1, j1, i1)
