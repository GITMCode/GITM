...
!     write(*,*)'It is Ok----------1b'
        ...
        ABT(i, j, k) = &
          AA1*B1*eTemperature(i, j, k, iBlock)**(B1 - 0.5) &
          *(c1*(Dx1(i, j, k) - Ex1(i, j, k)) &
            + 5.91e-9*(TempUnit(i, j, k)* &
        ...
        ABT(i, j, k) = &
          ABT(i, j, k) + AA2*B2*eTemperature(i, j, k, iBlock)**(B2 - 0.5) &
          *(c2*(Dx2(i, j, k) - Ex2(i, j, k)) &
            + 5.91e-9*(TempUnit(i, j, k)* &
                       Temperature(i, j, k, iBlock) - &
                       eTemperature(i, j, k, iBlock)) &
            *((1 + B2)*Dx2(i, j, k) + &
        ...
        ABT(i, j, k) = ABT(i, j, k) + AA3*B3*eTemperature(i, j, k, iBlock)**(B3 - 0.5) &
                       *(c3*(Dx3(i, j, k) - Ex3(i, j, k)) &
                         + 5.91e-9*(TempUnit(i, j, k)*Temperature(i, j, k, iBlock) - &
                                    eTemperature(i, j, k, iBlock)) &
                         *((1 + B3)*Dx3(i, j, k) + &
