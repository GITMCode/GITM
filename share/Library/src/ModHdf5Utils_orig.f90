...
contains
  ...
  subroutine save_hdf5_file(FileName, TypePosition, TypeStatus, StringHeader, &
    ...
    do iVar = 1, nVar
      ...
      call write_hdf5_data(FileID, UnknownNameArray(iVar), 4, &
                           (/CellsPerBlock(1), CellsPerBlock(2), CellsPerBlock(3), nBlkUsed/), &
  ...
  subroutine write_hdf5_data( &
    FileID, DatasetName, DatasetRank, nDatasetDimension, &
    nOffsetLocal, nBlocksLocalIn, CoordArray, nCellsLocalIn, Rank4RealData, &
    Rank3RealData, Rank2RealData, Rank1RealData, Rank4IntegerData, Rank3IntegerData, &
    Rank2IntegerData, Rank1IntegerData, CharacterData, nStringChars, RealAttribute1, &
    RealAttribute2, NameRealAttribute1, NameRealAttribute2, &
